...
<body>
    ...
    <div class="container-fluid banner d-flex align-items-center" id="home">
        <div class="container text-center text-white">
            ...
            .kategori-VGA {
                background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('./assets/images/VGA.png');
                background-size: cover;
                background-position: center;
                cursor: pointer;
            }
            ...
            .kategori-CPU {
                background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('./assets/images/CPU.png');
                background-size: cover;
                background-position: center;
                cursor: pointer;
            }
            ...
            .kategori-keyboard {
                background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('assets/images/keyboard.png');
                background-size: cover;
                background-position: center;
                cursor: pointer;
            }
            ...
            <div class="col-md-8 offset-md-2">
                <form action="src/client/product/produk.php" method="get">
    ...
    <div class="container-fluid py-5">
        ...
        <div class="row mt-5">
            <div class="col-md-4 mb-4">
                <a href="src/client/product/produk.php?kategori=VGA" class="no-decoration">
            ...
            <div class="col-md-4 mb-4">
                <a href="src/client/product/produk.php?kategori=CPU" class="no-decoration">
            ...
            <div class="col-md-4 mb-4">
                <a href="src/client/product/produk.php?kategori=keyboard" class="no-decoration">
                    <div
        ...
        <div class="container text-center">
            ...
            <div class="row mt-5"><?php while ($data=mysqli_fetch_array($queryProduk)) {
                    ...
                    <div class="card"><img style="object-fit: cover; object-position: center;" height="200px"
                            src="./assets/images/<?php echo $data['foto']; ?>" class="card-img-top" alt="">
                        <div class="card-body">
                            <h4 class="card-title"><?php echo $data['nama'] ?></h5>
                                ...
                                <p class="card-text text-center text-harga">Rp <?php echo $data['harga'] ?></p><a
                                    ...
                                    href="src/client/product/produk-detail.php?nama=<?php echo $data['nama'] ?>"
                ...
                ?>
            </div><a class="btn btn-outline-warning mt-3 p-2" href="src/client/product/produk.php">See More</a>
        </div>
    </div>

    <!-- < !-- Footer -->
    <?php require "./src/component/footer.php" ?><script src="assets/bootstrap/js/bootstrap.min.js"></script>
